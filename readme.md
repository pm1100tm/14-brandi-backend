...
### 2. 프로젝트 목적
* E-Commerce 애플리케이션의 실제 업무 중 발생할 수 있는 고려 사항과 그에 대한 정책을 설정하여, 웹 어플리케이션을 개발
* 대량 데이터 적재와 확장성을 고려하여 데이터 베이스를 모델링
* Flask Web Framework 를 채용하고 Raw Query 로 DAO 단을 처리하여 CRUD 기능 구현
* Transaction 처리를 이해한다.
* 서비스/관리자 기능에 대한 비지니스 로직을 설계 및 구현
